...
export const SideBar = () => {
  return (
    <aside className="h-full max-w-sm bg-white">
      <label
        htmlFor="checked"
        className="inline-flex items-center mt-3 cursor-pointer"
      >
        <span className="relative">
          <span className="block w-10 h-6 bg-gray-200 rounded-full shadow-inner" />
          <span className="absolute inset-y-0 left-0 block w-4 h-4 mt-1 ml-1 transition-transform duration-300 ease-in-out transform translate-x-full bg-purple-600 rounded-full shadow focus-within:shadow-outline">
            <input
              id="checked"
              type="checkbox"
      ...
      <nav className="mt-10">
        <a
          className="flex items-center px-8 py-2 text-gray-700 bg-gray-200 border-r-4 border-gray-700"
          href="#"
        >
          <svg
            className="w-5 h-5"
        ...
        <a
          className="flex items-center px-8 py-2 mt-5 text-gray-600 border-r-4 border-white hover:bg-gray-200 hover:text-gray-700 hover:border-gray-700"
          href="#"
        >
          <svg
            className="w-5 h-5"
